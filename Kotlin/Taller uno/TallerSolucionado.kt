...
/*C
Enunicado:
c.	Según el `Taller uno`.DANE, el número de desempleados corresponde al 8.15% de la
...
`Taller uno`.edad1--`Taller uno`.edad1-->Int
edad2--edad2-->Int
edad3--edad3-->Int
Datos de salida
...
/*
Eunciado:  f.	Un `Taller uno`.estacionamiento requiere determinar el cobro que debe aplicar a las
...
/*
Enunciado:Se requiere determinar el `Taller uno`.tiempo que tarda una persona en llegar de una ciudad a otra
...
universidad mediante la asignación de `Taller uno`.becas mensuales, para esto se tomarán en consideración los
...
Datos de salida
- `Taller uno`.becas para el estudiante--beca-->String
 */
